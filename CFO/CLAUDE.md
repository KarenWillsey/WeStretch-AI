...
memory specific to this role only. Read this file (and CFO/Memory.md) whenever
working here; cross-role conventions live in the repo root `CLAUDE.md`.

## Mandate

Financial model review, budget planning.

## Skills

- `CFO/skills/budget-planning/`
- `CFO/skills/financial-model-review/`
- `CFO/skills/jokes/`
...
CFO/Memory.md holds durable facts, feedback, and context specific to this role.
