...
memory specific to this role only. Read this file (and CPO/Memory.md) whenever
...
- `CPO/skills/roadmap-prioritization/`
- `CPO/skills/user-research-synthesis/`
...
CPO/Memory.md holds durable facts, feedback, and context specific to this role.
