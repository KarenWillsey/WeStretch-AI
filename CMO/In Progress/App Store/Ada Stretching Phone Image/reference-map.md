...
Assets and delivered output for the `ada-stretching-phone-image` skill (instructions live at `CMO/skills/ada-stretching-phone-image/SKILL.md`) — kept here, alongside the rest of the App Store image work, for human browsability.
