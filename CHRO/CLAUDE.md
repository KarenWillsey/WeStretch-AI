...
memory specific to this role only. Read this file (and CHRO/Memory.md) whenever
working here; cross-role conventions live in the repo root `CLAUDE.md`.

## Mandate

Hiring plan, org/culture review.

## Skills

- `CHRO/skills/hiring-plan/`
- `CHRO/skills/jokes/`
- `CHRO/skills/org-culture-review/`
...
CHRO/Memory.md holds durable facts, feedback, and context specific to this role.
