...
Scope: this folder is the CIO's isolated workspace — responsibilities, skills, and
memory specific to this role only. Read this file (and CIO/Memory.md) whenever
working here; cross-role conventions live in the repo root `CLAUDE.md`.

## Mandate

Data systems audit, data governance review.

## Skills

- `CIO/skills/data-governance-review/`
- `CIO/skills/data-systems-audit/`
- `CIO/skills/jokes/`
...
- `Ideas/` — early-stage CIO concepts, not yet started.
- `In Progress/` — active CIO initiatives. Each gets its own subfolder with its
  own `CLAUDE.md` + `Memory.md` pair once real work begins.
- `Ready/` — finished/decided CIO initiatives, kept for reference.

## Memory

CIO/Memory.md holds durable facts, feedback, and context specific to this role.
