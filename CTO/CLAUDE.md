...
Scope: this folder is the CTO's isolated workspace — responsibilities, skills, and
memory specific to this role only. Read this file (and CTO/Memory.md) whenever
working here; cross-role conventions live in the repo root `CLAUDE.md`.

## Mandate

Technical architecture review, engineering roadmap.

## Skills

- `CTO/skills/engineering-roadmap/`
- `CTO/skills/jokes/`
- `CTO/skills/tech-architecture-review/`
...
- `Ideas/` — early-stage CTO concepts, not yet started.
- `In Progress/` — active CTO initiatives. Each gets its own subfolder with its
  own `CLAUDE.md` + `Memory.md` pair once real work begins.
- `Ready/` — finished/decided CTO initiatives, kept for reference.

## Memory

CTO/Memory.md holds durable facts, feedback, and context specific to this role.
