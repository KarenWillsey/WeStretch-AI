...
Scope: this folder is the CGO's isolated workspace — responsibilities, skills, and
memory specific to this role only. Read this file (and CGO/Memory.md) whenever
working here; cross-role conventions live in the repo root `CLAUDE.md`.

## Mandate

Growth experiment design, retention funnel analysis.

## Skills

- `CGO/skills/growth-experiment-design/`
- `CGO/skills/jokes/`
- `CGO/skills/retention-funnel-analysis/`
...
- `Ideas/` — early-stage CGO concepts, not yet started.
- `In Progress/` — active CGO initiatives. Each gets its own subfolder with its
  own `CLAUDE.md` + `Memory.md` pair once real work begins.
- `Ready/` — finished/decided CGO initiatives, kept for reference.

## Memory

CGO/Memory.md holds durable facts, feedback, and context specific to this role.
