...
- Identity image: `assets/female-actor-05-reference.png`
- Prompt: `references/prompt-template.md`
- Identity image SHA-256:
  `42E634EBAAC4EE3A2A1B2AE84AD570F06CCAA5896DB6FCB793741A280874B493`
...
```text
Create image of Female Actor 05 in pose standing calf stretch against a wall.
```
...
1. Inspect `assets/female-actor-05-reference.png` before the first generation.
...
- Apparent age, facial proportions, dark brown wavy bob, complexion, body
  type, muted plum crew-neck tee, taupe-grey joggers, or bare feet drift from
  the reference.
...
- The head or hair is cropped, or the framing prevents the full pose from
  being understood.
- Unless explicitly overridden, the living room with fireplace, warm
  camera-right daylight, 3:4 style, or upper negative space changes
  materially.
