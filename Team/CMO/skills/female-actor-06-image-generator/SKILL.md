...
- Identity image: `assets/female-actor-06-reference.png`
- Prompt: `references/prompt-template.md`
- Identity image SHA-256:
  `04A79E11296A0BB984D72A69D6872097EAAD180254DF5DFC86FF1D3CE5A7BCD2`
...
```text
Create image of Female Actor 06 in pose standing calf stretch against a wall.
```
...
1. Inspect `assets/female-actor-06-reference.png` before the first generation.
...
- Apparent age, facial proportions, short dark tousled crop, complexion, body
  type, coral-terracotta crew-neck tee, taupe-grey leggings, or bare feet
...
- The head or hair is cropped, or the framing prevents the full pose from
  being understood.
- Unless explicitly overridden, the dining/living space, warm camera-right
  daylight, 3:4 style, or upper negative space changes materially.
