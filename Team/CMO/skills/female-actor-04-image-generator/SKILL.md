...
- Identity image: `assets/female-actor-04-reference.png`
- Prompt: `references/prompt-template.md`
- Identity image SHA-256:
  `2A5C43B623B127B0303CD7AC08144DE8C45E08C61BB89CADED546BC769EF6C53`
...
```text
Create image of Female Actor 04 in pose standing calf stretch against a wall.
```
...
1. Inspect `assets/female-actor-04-reference.png` before the first generation.
...
- Apparent age, facial proportions, long dark curly hair, complexion, body
  type, sage-green racerback tank top, charcoal-grey leggings, or bare feet
...
- The head or hair is cropped, or the framing prevents the full pose from
  being understood.
- Unless explicitly overridden, the bright open living space, warm
  camera-left daylight, 3:4 style, or upper negative space changes
  materially.
