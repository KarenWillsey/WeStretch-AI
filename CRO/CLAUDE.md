...
memory specific to this role only. Read this file (and CRO/Memory.md) whenever
...
- `CRO/skills/jokes/`
- `CRO/skills/pricing-strategy/`
- `CRO/skills/revenue-pipeline-review/`
...
CRO/Memory.md holds durable facts, feedback, and context specific to this role.
